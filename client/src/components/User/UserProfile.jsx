...
const UserProfile = () => {
  ...
  return (
    <div className='login-mainPage'>
      ...
      <div style={{ width: "50%", margin: "auto", marginTop: "100px", display: "flex", border: "2px solid white", borderRadius: "30px", padding: "20px",boxShadow: "rgba(0, 0, 0, 0.25) 0px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px" }}>
